  ...
  return (
    <div className="review">
      {isLoading ? "Loading ": error ?"SWR" :  <div className="user">
        <img
          className="pp"
          src={data.img || "https://i.imgur.com/6VBx3io.png"}
          alt=""
        />
        <div className="info">
      ...
      <div className="helpful">
        ...
        <span>Yes</span>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQekNdncs8dKIBfav4geFd1hiibRrDQmKIWkA&usqp=CAU" alt="" />
        <span>No</span>
      </div>
    </div>
  )
